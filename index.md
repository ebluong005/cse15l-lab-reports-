...
I will be researching the find command for this report.

**Command Option 1 (-type)**

The type command for files used to find the type of files. With type d as the input, the output will be all the directories in the file. 
The command input type f will give the output of all files in the branch.
...
This option searches for files or directories that are empty. This can be useful for finding directories that need to be cleaned up or files that should be deleted.
Example 1 
